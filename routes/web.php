...
Route::group(['middleware' => 'auth'], function() {
    ...
    //Lesson
    Route::post('/lesson', 'LessonController@index')->name('lesson.index');
    Route::get('/lesson/{lesson}', 'LessonController@showQuiz')->name('quiz.show');

    //Quiz
    Route::post('/quiz/answer/{lesson}', 'QuizController@answer')->name('quiz.answer');
    Route::get('/quiz/answer/{lesson}/results', 'QuizController@result')->name('quiz.result');
